...
#define THINGSBOARD_SERVER  "Your_IP_thingsboard_sv" //on the same server as device 1
#define THINGSBOARD_PORT    1883
#define ACCESS_TOKEN        "Your_access_token_2" //access token "device 2", which is generated in thingsboard
...
void sendToThingsBoard() {
  ...
  doc["engine_on"]    = running ? 1 : 0;
  doc["totalRunMinutes_2"]  = (unsigned long)(totalRunMs / 60000ULL);
  doc["totalIdleMinutes_2"] = (unsigned long)(totalIdleMs / 60000ULL);
  doc["latitude_2"]     = gpsValid ? gps.location.lat() : 0.0;
  doc["longitude_2"]    = gpsValid ? gps.location.lng() : 0.0;
  doc["temperature_2"]  = isnan(lastTemperature) ? 0.0 : lastTemperature;
  doc["power_mw_2"]     = lastPowermW;
